import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { watch, toRef, isRef, hasInjectionContext, inject, getCurrentInstance, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, computed, unref, shallowReactive, useSSRContext, ref, Suspense, Fragment, createApp, reactive, mergeProps, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, effectScope, isReadonly, isShallow, isReactive, toRaw, nextTick, getCurrentScope } from 'vue';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CfnVAcjb.mjs')
  },
  {
    name: "lang",
    path: "/:lang()",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-DVqPTNMo.mjs')
  }
];
...
const lang_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to) => {
  if (/^\/(?:_nuxt|api|scripts|.*\.(?:png|jpe?g|svg|gif|ico|webp|avif|xml|txt|webmanifest))/.test(
    to.path
  )) {
    return;
  }
...
const LazyIcon = defineAsyncComponent(() => import('./index-CgxZbI8Y.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-Br2LL2qq.mjs').then((m) => m.default || m))
};
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        tabindex: "-1",
        role: "progressbar",
        class: "fixed top-0 left-0 w-full h-3px bg-cyan-500 animate-pulse z-50"
      }, _attrs, {
...
_sfc_main$4.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/common/page-loader.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const __nuxt_component_4 = Object.assign(_sfc_main$4, { __name: "CommonPageLoader" });
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_CommonPageLoader = __nuxt_component_4;
                  ...
                  _push3(ssrRenderComponent(_component_NuxtLayout, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(_component_NuxtRouteAnnouncer, null, null, _parent4, _scopeId3));
                        ...
                        return [
                          createVNode(_component_ClientOnly, null, {
                            default: withCtx(() => [
                              createVNode(_component_CommonPageLoader)
                            ]),
                            _: 1
                          }),
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CmcwR1ZT.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-FwGI3m62.mjs'));
...
export { LANG as L, useLang as a, useHead as b, cn as c, useState as d, useNuxtApp as e, useAppConfig as f, asyncDataDefaults as g, createError as h, useRouter as i, nuxtLinkDefaults as j, navigateTo as n, resolveRouteObject as r, server as s, useRuntimeConfig as u };
