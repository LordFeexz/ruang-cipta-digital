...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "dfd15a4b-7a3a-4f09-8fc6-257e4c4f794d",
...
const _V0rTGMIEC0D99to1BPnRVOmTRKJ04dtVDyFwg29x7M = defineNitroPlugin(async (nitroApp) => {
...
const _bT66h9ze6aC94b2uvYiESOJVtQTuVSek3Op6aFg8AQ = defineNitroPlugin(async (nitroApp) => {
...
const _AlAqudLooSmcn3IbHpTfzfgG7oJG6E_0sI2dsv_z6iI = (function(nitro) {
...
const plugins = [
  _V0rTGMIEC0D99to1BPnRVOmTRKJ04dtVDyFwg29x7M,
_bT66h9ze6aC94b2uvYiESOJVtQTuVSek3Op6aFg8AQ,
_AlAqudLooSmcn3IbHpTfzfgG7oJG6E_0sI2dsv_z6iI
];
...
const _fAj2WW = defineCachedEventHandler(async (event) => {
...
const _AMq581 = eventHandler(async (e) => {
...
const _nqJIjL = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _T_e6G8 = defineEventHandler(async (e) => {
...
const _oU8j4A = defineEventHandler(async (e) => {
...
const _4h2OKK = defineEventHandler(sitemapXmlEventHandler);

const _4kbVyE = lazyEventHandler(() => {
...
const _lazy_PRYuMe = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_PRYuMe, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _fAj2WW, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _AMq581, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _nqJIjL, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _T_e6G8, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _oU8j4A, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _4h2OKK, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _4kbVyE, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_PRYuMe, lazy: true, middleware: false, method: undefined }
];
